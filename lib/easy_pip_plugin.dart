...
class EasyPipPlugin {
  ...
  // GEUPDATE: Accepteert nu de optionele startTimeInSeconds en geeft deze door aan de Pigeon API
  Future<void> setupAutoPiP({
    required int width,
    required int height,
    required String urlStr,
    double startTimeInSeconds = 0.0,
  }) async {
    // We sturen de textureId mee naar Pigeon/Native
    await _api.setupAutoPiP(width, height, urlStr, startTimeInSeconds);
  }
