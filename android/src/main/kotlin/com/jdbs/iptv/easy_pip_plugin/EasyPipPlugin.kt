...
class EasyPipPlugin: FlutterPlugin, ActivityAware, EasyPipApi {
    ...
    override fun getPiPStatus(): PipStatus {
        ...
        // GEUPDATE: Voldoet nu aan de uitgebreide klasse inclusief de lastPositionSeconds (die op Android null mag zijn)
        return PipStatus(
    ...
    // GEUPDATE: Voldoet nu aan de nieuwe Pigeon interface met de extra startTimeInSeconds parameter
    override fun setupAutoPiP(width: Long, height: Long, urlStr: String, startTimeInSeconds: Double) {
        val currentActivity = activity ?: return
        if (!isPiPSupported()) return
    ...
    private fun createPipParams(width: Int, height: Int, isPlaying: Boolean): PictureInPictureParams {
        ...
        // GEFIXT: Gebruik PendingIntent.FLAG_IMMUTABLE
