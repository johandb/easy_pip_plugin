...
struct PipStatus: Hashable, CustomStringConvertible {
  ...
  var lastPositionSeconds: Double? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PipStatus? {
    ...
    let lastPositionSeconds: Double? = nilOrValue(pigeonVar_list[2])
  ...
  static func == (lhs: PipStatus, rhs: PipStatus) -> Bool {
    ...
    return PipApiPigeonInternal.deepEquals(lhs.isSupported, rhs.isSupported) && PipApiPigeonInternal.deepEquals(lhs.isActive, rhs.isActive) && PipApiPigeonInternal.deepEquals(lhs.lastPositionSeconds, rhs.lastPositionSeconds)
  }
  ...
  func hash(into hasher: inout Hasher) {
    ...
    PipApiPigeonInternal.deepHash(value: lastPositionSeconds, hasher: &hasher)
  }

  public var description: String {
    return "PipStatus(isSupported: \(String(describing: isSupported)), isActive: \(String(describing: isActive)), lastPositionSeconds: \(String(describing: lastPositionSeconds)))"
  }
}
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: EasyPipApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      setupAutoPiPChannel.setMessageHandler { message, reply in
        ...
        let startTimeInSecondsArg = args[3] as! Double
        do {
          try api.setupAutoPiP(width: widthArg, height: heightArg, urlStr: urlStrArg, startTimeInSeconds: startTimeInSecondsArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
